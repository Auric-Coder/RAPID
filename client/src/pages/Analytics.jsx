...
function Analytics() {
  // Step 13: previously initialized with hardcoded-looking numbers
  // (totalDrones: 5, averageBattery: 100, ...) that a user could mistake
  // for real data during the fetch window. `loading` now gates a skeleton
  // instead, and these defaults only need to be structurally valid (never
  // rendered as real values).
