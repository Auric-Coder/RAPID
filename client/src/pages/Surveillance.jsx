...
function Surveillance() {
  ...
  // Step 13: without this, "No patrol missions for this state yet" showed
  // during every fetch, not just when a state genuinely has none. This
  // effect also re-runs on activeState changes (refresh is a useCallback
  // keyed on it), so loading legitimately toggles again on a state
  // switch too - a different dataset is being fetched, not just on mount.
